...
# Elevation just to generate another scalar attribute that varies 
# nicely over the data range
...
# I would call Update if I could use the scalar range to set the color 
# map range
# glyph.Update()
